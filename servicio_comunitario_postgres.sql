-- ============================================================================
--  Servicio Comunitario — Base de datos transcrita de MySQL/MariaDB a PostgreSQL
--  Generado a partir de servicio_comunitario.sql
--
--  Cómo cargarlo:
--    1) createdb servicio_comunitario
--    2) psql -d servicio_comunitario -f servicio_comunitario_postgres.sql
--
--  Notas de la traducción MySQL -> PostgreSQL:
--    - int(11)                 -> integer
--    - AUTO_INCREMENT          -> GENERATED BY DEFAULT AS IDENTITY (+ setval al final)
--    - enum(...)               -> tipos ENUM nativos (CREATE TYPE ...)
--    - decimal(10,2)           -> numeric(10,2)
--    - datetime                -> timestamp
--    - DEFAULT current_timestamp() -> DEFAULT CURRENT_TIMESTAMP
--    - ON UPDATE current_timestamp() -> trigger (registro_bombonas.fecha_actualizacion)
--    - backticks `col`         -> identificadores sin comillas (minúsculas)
-- ============================================================================
...
-- ----------------------------------------------------------------------------
--  Claves foráneas (equivalentes a las restricciones de MySQL)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
--  Índices (idénticos a los de MySQL)
-- ----------------------------------------------------------------------------
